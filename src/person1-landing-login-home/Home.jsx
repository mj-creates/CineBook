...
const movies = [
    { id:1, title: "The Batman", language: "English", color: '#ffe08a', emoji: '🦇' },
    { id:2, title: "Kalki Returns", language: "Telugu", color: '#ffb3b3', emoji: '🌌' },
    { id:3, title: "Dil se Dosti", language: "Hindi", color: '#b3d9ff', emoji: '💞' },
];
